...
sll1.insert(1);
// linked list is now: 1 -> null
sll1.insert(12);
// linked list is now: 12 -> 1 -> null
sll1.insert(20);
// linked list is now: 20 -> 12 -> 1 -> null
...
// ddl1's structure: tail: 10  head: 10
dll1.insertAtHead(12);
// ddl1's structure: tail: 10  head: 12
...
// ddl1's structure: tail: 30  head: 20
...
dll1.insertAtTail(30);
// ddl1's structure: tail: 30  head: 20
dll1.findStartingTail(10);
// true
dll1.findStartingTail(100);
// false
